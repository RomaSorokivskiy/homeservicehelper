...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    meal: mealItem ? { title: mealItem.title || "Запланована страва", note: mealItem.text || mealItem.description || "У плані на сьогодні", servings: Number(String(mealItem.text||"").match(/Порції:\s*(\d+)/)?.[1]) || 2 } : null,
